...
Welcome to the first level of the Stratum course. Before we can build complex, full-stack generators, we need to establish a shared vocabulary for how we think about, discuss, and document software.

---

## Level Properties

As required by the Stratum pedagogical framework, here are the parameters for this level:
